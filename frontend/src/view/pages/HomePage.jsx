      ...
      <nav className="fixed w-full z-50 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link to="/information" className="text-white hover:text-green-200">Information</Link>
            <Link to="/about" className="text-white hover:text-green-200">About</Link>
          {/* Tambahkan kondisional untuk admin */}
						{user && user.role === 'admin' && (
						<Link to="/parks/new" className="text-white hover:text-green-200">Create Park</Link>
					)}
					</div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link 
              to="/login" 
              className="text-white border border-white px-4 py-2 rounded-full hover:bg-white/20 transition"
            >
              Login
            </Link>
            <Link 
              to="/signup" 
              className="bg-white text-green-800 px-4 py-2 rounded-full hover:bg-green-50 transition"
            >
              Sign Up
            </Link>
          </div>
